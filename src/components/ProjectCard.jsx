...
const ProjectCard = ({
  ...
  return (
    <div className="py-2 md:py-3 px-3 md:px-5 border-1 border-pink-500 bg-gradient-to-b from-orange-950 to-transparent shadow-xl w-[300px] md:w-[500px] rounded-2xl my-2">
      ...
      <div className="flex flex-wrap gap-1">
        {techStack.map((tech, i) => {
          return (
            <p
              key={i}
              className="px-1 my-1 bg-gray-600 text-sm rounded-md text-white"
            >
              {tech}
            </p>
          );
      ...
      <div className="my-2 md:my-4 flex justify-evenly">
        <Link to={demoLink}>
