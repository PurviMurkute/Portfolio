...
const Skills = () => {
  return (
    <div
      name="skills"
      className="bg-gradient-to-b from-white via-slate-100 to-slate-200 flex flex-col justify-center items-center p-4 md:p-10"
    >
      <div className="md:w-[70%]">
        <h1 className="font-extrabold text-2xl md:text-4xl text-center text-pink-500">
          Skills & Technologies
        </h1>
        <div className="flex flex-col justify-center items-center">
          ...
          <h3 className="font-bold text-gray-600 text-xl md:text-2xl my-5">
            Web Technologies
          </h3>
          ...
          <h3 className="font-bold text-gray-700 text-xl md:text-2xl my-5">
            Tools & Platform
          </h3>
          <div className="flex justify-center flex-wrap gap-3 md:gap-7 mb-4">
          ...
          <h3 className="font-bold text-gray-700 text-xl md:text-2xl py-4">
            Databases
          </h3>
          <div className="flex justify-center flex-wrap gap-3 md:gap-7 mb-4">
            {DataBase.map((tech, i) => {
