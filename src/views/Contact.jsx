...
const Contact = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl md:text-4xl text-pink-500 font-extrabold">
        Let's Connect
      </h1>
      ...
      >
        <input
          ...
          className="border-1 border-pink-300 px-4 py-2 my-3 rounded-2xl text-gray-700 bg-slate-50"
        />
        <input
          type="text"
          name="email"
        ...
        <button
          type="submit"
          className="text-xl font-bold text-pink-100 px-6 py-2 border-1 border-pink-300 my-4 rounded-full bg-gradient-to-b from-orange-950 to-orange-900 cursor-pointer"
        >
          Submit
        </button>
      </form>
